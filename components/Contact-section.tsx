...
const Contact = () => {
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row items-center gap-y-4 md:gap-x-4 m-8 md:m-24 md:h-[480px] w-11/12 md:w-full"
    >
      <Image src='/cta.png' alt="contact" width={600} height={480} className="order-last md:order-1" />
