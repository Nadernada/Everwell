...
const DiscoverProduct = () => {
  return (
    <motion.div
      ...
      className="bg-primary rounded-se-[150px] lg:rounded-se-[200px] lg:rounded-3xl pt-16 px-8 lg:px-0 lg:py-0  md:m-12 flex flex-col lg:flex-row justify-between gap-y-0 lg:gap-x-14 lg:w-11/12 z-10 2xl:max-w-[1440px]"
    >
