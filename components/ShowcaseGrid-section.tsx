...
const Showcase = () => {
  return (
    ...
    >
      ...
      <Image src='/grid-pic1.png' alt="product" width={665} height={625} className="h-auto w-full lg:h-[625px] lg:w-[665px] lg:rounded-se-2xl" />

      <Image src='/grid-pic2.png' alt="product" width={665} height={625} className="h-auto w-fill lg:h-[625px] lg:w-[665px] order-last lg:order-none lg:rounded-es-2xl" />
      <div className="p-12 lg:p-24 flex flex-col justify-center gap-y-6 lg:gap-y-12">
