...
const Showcase = () => {
  return (
    ...
    >
      ...
      <Image src='/grid-pic1.png' alt="product" width={665} height={625} className="h-[450px] w-[450px] md:h-[625px] md:w-[665px]" />

      <Image src='/grid-pic2.png' alt="product" width={665} height={625} className="h-[450px] w-[450px] md:h-[625px] md:w-[665px]" />
      <div className="p-8 md:p-24 flex flex-col justify-center gap-y-4 md:gap-y-12">
        <h5 className={`text-[24px] md:text-[38px] leading-[32px] md:leading-[46px] text-primary ${myFontMedium.className}`}>Your Path to Total Wellness Begins Here</h5>
