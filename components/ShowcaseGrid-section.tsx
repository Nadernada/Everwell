...
const Showcase = () => {
  return (
    ...
    >
      ...
      <Image src='/grid-pic1.webp' alt="product" width={665} height={625} className="h-auto w-full lg:h-[625px] lg:w-full lg:rounded-se-2xl" />

      <Image src='/grid-pic2.webp' alt="product" width={665} height={625} className="h-auto w-full lg:h-[625px] lg:w-full order-last lg:order-none lg:rounded-b-2xl" />
      <div className="p-12 lg:p-24 flex flex-col justify-center gap-y-6 lg:gap-y-12">
