...
const Showcase = () => {
  return (
    <motion.div
      ...
      className="my-12 md:mx-24 rounded-3xl grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-y-0 w-11/12 bg-[#eaeaea]"
    >
      ...
      <Image src='/grid-pic1.png' alt="product" width={665} height={625} className="h-auto w-full md:h-[625px] md:w-[665px] md:rounded-se-2xl" />

      <Image src='/grid-pic2.png' alt="product" width={665} height={625} className="h-auto w-fill md:h-[625px] md:w-[665px] order-last md:order-none md:rounded-es-2xl" />
      <div className="p-12 md:p-24 flex flex-col justify-center gap-y-6 md:gap-y-12">
