...
const Showcase = () => {
  return (
    <motion.div
      ...
      className="my-12 lg:mx-24 rounded-3xl grid grid-cols-1 lg:grid-cols-2 gap-y-8 lg:gap-y-0 w-11/12 bg-[#eaeaea] 2xl:max-w-[1440px]"
    >
      ...
      <Image src='/grid-pic2.png' alt="product" width={665} height={625} className="h-auto w-full lg:h-[625px] lg:w-full order-last lg:order-none lg:rounded-b-2xl" />
      <div className="p-12 lg:p-24 flex flex-col justify-center gap-y-6 lg:gap-y-12">
