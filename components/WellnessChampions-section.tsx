  ...
  return (
    <div className="relative w-full flex flex-col items-center gap-y-6 pb-24 ">
      ...
      <div className="w-full flex flex-row justify-between items-center">
        ...
        >
          <Image src='/championsLeft.svg' alt="champions" width={502} height={150} className="h-[100px] md:h-[170px] scale-125 md:scale-100 -translate-x-12 md:-translate-x-24"/>
        </motion.div>
        ...
        >
          ...
          <h2 className={`${myFontMedium.className} text-[28px] md:text-[56px] leading-[24px] md:leading-[64px] text-center text-primary`}>Meet our Wellness Champions</h2>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <Image src='/championsRight.svg' alt="champions" width={502} height={150} className="h-[100px] md:h-[170px] scale-125 md:scale-100 translate-x-12 md:translate-x-24"/>
      </motion.div>
      </div>
