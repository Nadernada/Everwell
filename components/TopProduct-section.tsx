...
const TopProduct = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-b md:mt-24">
      <motion.div
        initial={{ opacity: 0, scale: 0.5, y: 0 }}
        whileInView={{ opacity: 1, scale: 1, y: 0 }}
        transition={{ duration: 0.2 }}
        className={`relative bg-gradient-to-b to-transparent w-full flex flex-col md:flex-row py-10 my-24 md:px-24 ${bgColor}`}
      >
        <Swiper
          spaceBetween={50}
          slidesPerView={1}
        ...
        >
          <SwiperSlide className="w-full flex flex-col md:flex-row md:items-center justify-center gap-y-12">
            {
              ({ isActive }) => {
                ...
                return (
                  <>
                    <motion.div
                      ...
                      className={`flex flex-col justify-center md:w-7/12 gap-y-4 px-8 md:ps-24 ${bgColor} transition-all`}
                    >
                    ...
                    <Image src='/TopProductGold.png' alt="bottle" width={650} height={650} className="w-[350px] md:w-[650px] "/>
                  </>
                )
              }
            }
                ...
                return (
                  <>
                    <motion.div
                      ...
                      whileInView={{ opacity: 1, scale: 1 }}
                      transition={{ duration: 0.5 }}
                      className={`flex flex-col justify-center md:w-7/12 gap-y-4 px-8 md:ps-24 ${bgColor}`}
                    >
                      <h2 className={`${myFont.className} font-bold text-[45px] md:text-[74px] text-primary leading-[55px] md:leading-[84px]`}>Immunity:<br />Immune Vitality</h2>
                      <p className="text-xs md:w-2/3">Meet the superhero of your well-being journey: 'Immune Vitality.' It's your trusty sidekick in the battle for a strong and robust immune system. Whether you're facing the sneezes or just want to stay in your prime, 'Immune Vitality' has your back. With 'Immune Vitality,' you're not just well; you're invincible!</p>
                      <Button title="Buy Now" fill className="mt-4 md:mt-12"/>
                    ...
                    <Image src='/TopProductBlue.svg' alt="bottle" width={650} height={650} className="w-[350px] md:w-[650px]"/>
                  </>
                )
              }
            }
